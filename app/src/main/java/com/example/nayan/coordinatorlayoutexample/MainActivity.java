...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.main_ioexample_textview2).setOnClickListener(this);
        ...
        findViewById(R.id.main_tab_textview).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.main_ioexample_textview:
                ...
                break;
            case R.id.main_ioexample_textview2:
                IOActivityExample2.start(this);
                break;
